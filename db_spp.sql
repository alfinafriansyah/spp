...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2023 at 01:44 AM
...
INSERT INTO `kelas` (`id_kelas`, `nama_kelas`, `id_komp`) VALUES
(1, 'XII', 1),
(2, 'X', 1),
(4, 'XI', 1),
(5, 'X', 3),
...
INSERT INTO `kompetensi` (`id_komp`, `nama_komp`) VALUES
(1, 'RPL'),
(3, 'TKJ');
...
(5, 'petugas', 'petugas', 'Petugas', 'petugas');
...
('9282763232', '35678176', 'Arya', 5, 'Bandung', '086738472873', 1, 'arrya');
...
INSERT INTO `spp` (`id_spp`, `tahun`, `golongan`, `nominal`) VALUES
(1, 2023, '1', 200000),
(2, 2023, '2', 250000);
...
--
ALTER TABLE `kelas`
  ADD CONSTRAINT `fk_kelas` FOREIGN KEY (`id_komp`) REFERENCES `kompetensi` (`id_komp`) ON DELETE CASCADE ON UPDATE CASCADE;
